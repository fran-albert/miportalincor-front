...
export default function OperatorPrescriptionRequests() {
  ...
  } = useSearchOperatorPendingRequests({ initialLimit: 20 });
  ...
  const EmptyState = ({ message }: { message: string }) => (
    <div className="text-center py-12">
      ...
      <p className="text-sm text-gray-500">
        Cuando haya solicitudes de recetas, aparecerán aquí
      </p>
    </div>
  );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/80 mt-1">
                  Gestione las solicitudes de recetas de todos los médicos
                </p>
              </div>
            </div>
            <Button
        ...
        <CardContent className="p-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full justify-start rounded-none border-b bg-transparent p-0">
              <TabsTrigger
                value="pending"
                className="rounded-none border-b-2 border-transparent px-6 py-3 data-[state=active]:border-blue-600 data-[state=active]:text-blue-600 data-[state=active]:shadow-none"
              >
