...
export const PERMISSIONS = {
  ...
  CONVERSATIONS: [Role.SECRETARIA, Role.ADMINISTRADOR],
  ...
  PRESCRIPTION_REPORTS: [Role.ADMINISTRADOR],
  ...
  PRESCRIPTION_CENTER: [Role.ADMINISTRADOR],
  ...
  OPERATOR_PRESCRIPTION_REQUESTS: [Role.SECRETARIA, Role.ADMINISTRADOR],
