...
export interface StudyReportListItem { sourceInboxItemId: string; report: StudyReport | null; state: StudyReportState; patientName: string | null; patientDni: string | null; studyDate: string | null; studyType: string | null; }
